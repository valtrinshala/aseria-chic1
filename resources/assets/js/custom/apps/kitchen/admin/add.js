...
var KTModalCustomersAdd = function () {
    ...
    var handleForm = function () {
        ...
        $('#submitButton').on('click', function () {
            $('#kt_ecommerce_add_kitchen_form').submit();
        });
        $('#kt_ecommerce_add_kitchen_form').submit(function (e) {
            var formData = new FormData($('#kt_ecommerce_add_kitchen_form')[0]);
            if ($('#method').val() === 'create'){
                var url =  '/admin/kitchen-android/devices';
            }else if ($('#method').val() === 'update' ){
                url =  '/admin/kitchen-android/devices/'+$('#page-id').val();
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                Swal.fire({
                                    ...
                                    if ($('#method').val() === 'create'){
                                        $('#kt_ecommerce_add_kitchen_form')[0].reset();
                                    }else {
                                        location.href = '/admin/kitchen-android/devices'
                                    }
                                });
                            },
                            statusCode: {
    ...
    return {
        init: function () {
            form = document.querySelector('#kt_ecommerce_add_kitchen_form');

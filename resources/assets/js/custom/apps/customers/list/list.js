...
var KTCustomersList = function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            d.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    text: window.keys.deleteText + customerName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        ...
                        Swal.fire({
                            text: customerName + window.keys.notDeleted,
                            icon: "error",
                            buttonsStyling: false,
    ...
    var initToggleToolbar = () => {
        ...
        deleteSelected.addEventListener('click', function () {
            ...
            Swal.fire({
                text: window.keys.deletedCustomers,
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: window.keys.confirmButtonText,
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "/admin/customer/delete/selected",
                        method: "POST",
                        data: { ids: ids },
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    Swal.fire({
                        text: window.keys.selectedCustomers,
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: window.keys.confirmButtonOk,
                        customClass: {

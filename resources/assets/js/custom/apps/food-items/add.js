    ...
    var handleForm = function () {
        ...
        $('#activated').change(function () {
            if ($(this).is(':checked')) {
                ...
                table.find('.medium').css('display', '')
                table.find('.small').css('display', '')
                table.find('#medium').prop('checked', true)
                table.find('#small').prop('checked', true)
            } else {
                table.find('input[type="checkbox"]').prop('checked', false);
                // table.find('input[type="number"]').val(0);
                table.css('display', 'none');
            }
        });
        $('#large').change(function () {
            if ($(this).is(':checked')) {
                table.find('.large').css('display', '')
            } else {
                table.find('.large').css('display', 'none')
        ...
        $('#small').change(function () {
            if ($(this).is(':checked')) {
                ...
                $('.large input[type="number"]').prop('disabled', false).val(0);
            } else {
                        ...
                        if (selectedCount === 1){
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    Swal.fire({
                                        text: window.keys.productSuccessfullyAdded,
                                        icon: "success",
                                        buttonsStyling: false,
                                        confirmButtonText: window.keys.confirmButtonOk,
                                        ...
                                        // $('#kt_ecommerce_add_product_form select').val(null).trigger('change');

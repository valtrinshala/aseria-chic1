...
var KTModalCustomersAdd = function () {
    ...
    var handleForm = function () {
        ...
        $('#kt_customers_table tbody tr').each(function () {
            selectedFoodItems.push(this.id)
        })
        ...
        $('#foodItemDropdown').on('change', function () {
            ...
            if (selectedFoodItems.includes(selectedProduct.id)) {
                ...
                newRow.append('<td><a href="' + urlEdit + '" class="text-gray-800 text-hover-primary mb-1">' + selectedProduct.name + '</a></td>');
                // newRow.append('<td data-quantity = "' + selectedProduct.quantity + '">' + parseFloat(selectedProduct.quantity) + ' ' + selectedProduct.unit + '</td>');
                newRow.append('<td data-qty = "' + 1 + '">' + 1 + '</td>');
                if (direction == 'end') {
                    newRow.append('<td data-cost = "' + parseFloat(selectedProduct.cost).toFixed(2) + '">' + parseFloat(selectedProduct.cost).toFixed(2) + '  ' + currency + '</td>');
                    newRow.append('<td data-price = "' + parseFloat(selectedProduct.price).toFixed(2) + '">' + parseFloat(selectedProduct.price).toFixed(2) + '  ' + currency + '</td>');
                }else {
                    newRow.append('<td data-cost = "' + parseFloat(selectedProduct.cost).toFixed(2) + '">'+ currency + ' '+ parseFloat(selectedProduct.cost).toFixed(2)+'</td>');
                    newRow.append('<td data-price = "' + parseFloat(selectedProduct.price).toFixed(2) + '">'+ currency+' '+ parseFloat(selectedProduct.price).toFixed(2)+'</td>');
                }
                newRow.append('<td class="float-right pe-0"><div class="float-end menu-item px-3 pe-0"><a href="javascript:void(0)" class="menu-link px-3 text-danger" data-foodItem-id="new_id" data-kt-customer-table-filter="delete_row">Delete</a></div></td>');

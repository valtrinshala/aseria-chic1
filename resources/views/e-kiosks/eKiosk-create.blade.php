            ...
            <div id="kt_app_toolbar" class="app-toolbar px-0 py-8">
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        ...
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ __('Add new eKiosk') }}</span>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_eKiosk_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="requestId" name="requestId" value="{{ $incomingRequest?->id }}">
                                            ...
                                            <div class="card-body pt-4">
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="name" type="text" name="name" value="{{ $incomingRequest?->e_kiosk_name }}"
                                                            class="form-control mb-2" placeholder="Ex. Kiosk 1" />
                                                    </div>
                                                    <div class="mb-10 fv-row col">
                                                        <label for="e_kiosk_id"
                                                            class="required form-label fw-bold">{{ __('eKiosk ID') }}</label>
                                                        <div class="shared-input-container mb-2">
                                                        <input id="e_kiosk_id" type="password" name="e_kiosk_id" @if($incomingRequest) disabled @endif
                                                            class="form-control text-gray-900 disabled" value="{{ $incomingRequest?->device_id }}"
                                                        ...
                                                        @if($incomingRequest)
                                                        <input id="e_kiosk_id" type="hidden" name="e_kiosk_id"
                                                            class="form-control mb-2 text-gray-900 disabled" value="{{ $incomingRequest?->device_id }}"
                                                            placeholder="Unique ID" />
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mb-10 fv-row col-6">
                                                        ...
                                                        <div class="shared-input-container mb-2">
                                                            <input id="authentication_code" type="password"
                                                                ...
                                                                class="form-control"
                                                                   value="{{ $incomingRequest?->authentication_code }}"
                                                    ...
                                                    <div class="mb-10 fv-row col-6 ps-8">
                                                        <label class="form-check-label mb-4" for="activated"><span
                                                            ...
                                                            <span
                                                                class="small p-5 text-muted">{{ __('When the eKiosk is deactivated, it cannot be used.') }}</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="row fv-row">
                                                        ...
                                                        <textarea name="description" id="description" class="ms-3 form-control mb-3" rows="3"
                                                                  placeholder="{{ __('Type a message') }}">{{ $incomingRequest?->description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('queueManagement.index') }}"
                            class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Update Queue Management') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $queueManagement->name }}</span>
                    </div>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_queueManagement_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $queueManagement->id }}">
                                                ...
                                                <div class="row">
                                                    <div class="mb-10 fv-row col-4">
                                                        ...
                                                        <input id="name" type="text" name="name"
                                                            value="{{ $queueManagement->name }}" class="form-control mb-2"
                                                            placeholder="{{ __('Queue name') }}" />
                                                    </div>
                                                    <div class="mb-10 col-4 fv-row">
                                                        <label for="hidden_key"
                                                            class="required form-label fw-bold">{{ __('Key') }}</label>
                                                        <input id="hidden_key" disabled type="text" name="key"
                                                            value="{{ $queueManagement->key }}" class="form-control mb-2"
                                                            placeholder="{{ __('Key') }}" />
                                                        <input type="hidden" id="key" name="key" value="{{ $queueManagement->key }}" />
                                                    </div>
                                                    <div class="mb-10 fv-row col-4">
                                                        <label for="e_kiosk_id"
                                                            class="required form-label fw-bold">{{ __('Queue location') }}</label>
                                                        <input id="e_kiosk_id" type="text" disabled
                                                            value="{{ $queueManagement->location?->name }}"
                                            ...
                                            <div class="card-header">
                                                <div class="card-title">
                                                    <h2>{{ __('Authentication') }}</h2><span
                                                        class="small ms-2 text-gray-900">{{ __('Configure queue authentication') }}</span>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0 pb-0">
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="authentication_code" type="password"
                                                            ...
                                                            value="{{ $queueManagement->authentication_code }}"
                                                            class="form-control"
                                                    ...
                                                    <div class="mb-10 fv-row col">
                                                        <label class="form-check-label mb-4" for="activated"><span
                                                            ...
                                                            <span
                                                                class="small p-5 text-muted text-nowrap">{{ __('Enter authentication code') }}
                                                            </span></label>
                                                        <div class="form-check form-switch">
                                                            ...
                                                            <input class="form-check-input" id="authentication_code_status"
                                                                ...
                                                                role="checkbox"
                                                                {{ $queueManagement->authentication_code_status ? 'checked' : '' }}
                                                                value="1">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-header">
                                                <div class="card-title">
                                                    <h2>{{ __('Queue URL') }}</h2><span
                                                        class="small ms-2 text-gray-900">{{ __('Configure queue link') }}</span>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0 pb-0">
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        <label for="url"
                                                            class="required form-label fw-bold">{{ __('URL') }}</label>
                                                    ...
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <div class="form-check form-switch">
                                                            ...
                                                            <input class="form-check-input" id="status" name="status"
                                                                ...
                                                                {{ $queueManagement->status ? 'checked' : '' }}
                                                                value="1">
                                                        </div>
                                                    </div>
                                                </div>

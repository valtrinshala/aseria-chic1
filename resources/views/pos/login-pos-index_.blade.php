                        ...
                        <div class="fv-row col-12 ">
                            <div class="d-flex flex-column gap-4">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="monthly-report-step btn btn-primary fw-bold btn-block create-account-btn w-100 mt-6">{{ __('Monthly Reports') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<div id="monthly-rep-register" class="modal fade" data-backdrop="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">

            <div class="app-main flex-column flex-row-fluid bg-violet" id="kt_app_main">
                <div class="tab-content d-flex justify-content-center flex-column flex-lg-row align-items-center h-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <select id="cash_register" name="cash_register"
                                            ...
                                            data-placeholder="{{ __('Select a cash register') }}">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
                            <button type="button" class="select-cash-register btn btn-primary w-100">{{ __('Select') }}</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="monthly-rep-register-months" class="modal fade" data-backdrop="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="app-main flex-column flex-row-fluid bg-violet" id="kt_app_main">
                <div class="tab-content d-flex justify-content-center flex-column flex-lg-row align-items-center h-100">
                    <div class="card card-flush py-4 w-50 align-self-center text-center w-600px">
                        <div class="card-header justify-content-center">
                            <div class="card-title">
                                    <h2>{{ __('Print a month') }}</h3>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            <!--
                                <div class="row mb-5 mx-0 month-list-cashregister">
                                </div>
                            -->
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="row mx-0 gap-5">
                                <button type="button" class="monthly-report-step btn btn-primary col">{{ __('Switch cash register') }}</button>
                                <button type="button" class="print-current-month btn btn-primary col">{{ __('Print') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="confirm-reprint-z-report" class="modal fade" data-backdrop="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">

            <div class="app-main flex-column flex-row-fluid bg-violet" id="kt_app_main">
                <div class="tab-content d-flex justify-content-center flex-column flex-lg-row align-items-center h-100">
                    <div class="card card-flush py-4 w-50 align-self-center text-center w-600px p-4">
                        <div class="modal-header px-0 justify-content-center">
                            <div class="modal-title text-md text-center fs-3 fw-bold text-center ">{{ __('Pin for') }} <span class="cashregister-name"></span></div>
                        </div>

                        <form class="d-flex flex-column mb-0 pin-submit">
                            <div class="d-flex flex-column mb-0 gap-4">
                                <div class="more-btn-modal">
                                    <input class="form-control text-center" id="pin-z-rep" inputmode="numeric" type="password" placeholder="{{ __('Password') }}">
                                </div>
                                <div>
                                    <div class="d-flex gap-4">
                                        <a href="#" class="w-100 btn font-span discard-pin-zreport py-4 gray-border discard-btn">{{ __('Discard actions') }}</a>
                                        <input class="w-100 text-center btn btn-primary text-white" type="submit" value="{{ __('Open') }}">
                                    </div>
                                </div>
                            </div>
                        </form>

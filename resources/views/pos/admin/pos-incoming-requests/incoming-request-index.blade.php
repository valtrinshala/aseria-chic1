...
@section('setup-script')
    @vite('resources/assets/js/custom/apps/pos/admin/remove-incoming-requests.js')
                        ...
                        <div class="card card-body pt-0">
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_incomingRequests_table">
                                ...
                                <tr class="text-start text-gray-600 fs-6 gs-0">
                                    ...
                                    <th class="text-gray-900 fw-bold min-w-125px pt-10 pb-10">{{ __('Pos ID') }}</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('devices-pos.create', ['posIncomingRequestId' => $incomingRequest->id ]) }}"

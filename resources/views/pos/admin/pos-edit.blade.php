                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('devices-pos.index') }}"
                            class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Update Pos') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $pos->name }}</span>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_pos_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $pos->id }}">
                                            ...
                                            <div class="card-body pt-4">
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="name" type="text" name="name"
                                                            value="{{ $pos->name }}" class="form-control mb-2"
                                                    ...
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="pos_id" type="password" name="pos_id" disabled
                                                            value="{{ $pos->pos_id }}" class="form-control"
                                                ...
                                                <div class="row">
                                                    <div class="mb-10 fv-row col-6">
                                                        ...
                                                        <div class="shared-input-container mb-2">
                                                            <input id="authentication_code" type="password" name="authentication_code" value="{{ $pos->authentication_code }}" class="form-control" placeholder="Write password here" />
                                                            <span class="toggle-password">
                                                                <i class="fa fa-eye-slash"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="mb-10 fv-row col-6">
                                                        <label for="dropdown"
                                                            ...
                                                            <select name="location_id" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="{{ __('Select an option') }}">
                                                                ...
                                                                <option @selected($eachLocation->id == $pos->location_id) value="{{ $eachLocation->id }}">
                                                                {{$eachLocation->name}}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="mb-10 fv-row col-6 ps-8">
                                                        <label class="form-check-label mb-4" for="activated"><span
                                                            ...
                                                            <span
                                                                class="small p-5 text-muted text-nowrap">{{ __('When the pos is deactivated, it cannot be used.') }}</span></label>
                                                ...
                                                <div class="row">
                                                    <div class="row fv-row">
                                                        ...
                                                        <textarea name="description" id="description" class="ms-3 form-control mb-3" rows="3"
                                                                  placeholder="{{ __('Type a message') }}">{{ $pos->description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

...
@section('content')
    ...
    <div class="app-main flex-column flex-row-fluid h-100vmin overflow-hidden" id="kt_app_main">
                ...
                <div id="kt_app_content_container" class="app-container kitchen-layout-container container-xxl h-100 p-0">
                    <div class="primary-table-content d-flex overflow-hidden position-relative">
                        <div id="kt_app_content_container" class="p-0 app-container container-xxl">
                            ...
                            <div class="card px-4 py-4 shadow-none" style="background: transparent">
                                    ...
                                    <table class="table align-middle order-filter-table table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                        <thead>
                                            <tr class="text-start text-gray-600 fs-6 gs-0">
                                                ...
                                                <th class="text-end text-gray-900 fw-bold min-w-125px pt-10 pb-10 pe-2">{{ __('Paid with') }}
                                                </th>
                                                <th class="text-end text-gray-900 fw-bold min-w-125px pt-10 pb-10 pe-2">{{ __('Created date') }}
                                                </th>
                                                <th class="text-end text-gray-900 fw-bold min-w-125px pt-10 pb-10 pe-4">{{ __('Status') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($order_list as $sale)
                                                <tr>
                                                    ...
                                                    <td class="text-end text-gray-800 fs-10.5 flex-column justify-content-center my-0">

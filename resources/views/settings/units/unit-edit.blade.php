                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        ...
                        <a href="{{ route('unit.index') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0 m-4">{{ __('Unit Details') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $unit->name }}
                           </span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <button class="btn delete-button btn-danger w-125px border-0"
                                data-id="{{ $unit->id }}"
                                data-name="{{ $unit->name }}">{{ __('Delete') }}</button>
                        <a href="{{ route('unit.index') }}"
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_unit_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $unit->id }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row fv-row">
                                                        ...
                                                        <textarea name="description" id="description" class="ms-3 form-control mb-3" rows="3"
                                                                  placeholder="{{ __('Type a message') }}">{{ $unit->description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

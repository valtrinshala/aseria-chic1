...
@section('title', 'Create device settings')
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                        <div class="page-title d-flex justify-content-center flex-wrap me-3">
                            ...
                            <a href="{{ route('printerSettings.index') }}"
                               class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0 m-4">{{ __('Device settings') }} > </a>
                            <span
                                class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ __('Add a new device')}}
                            </span>
                        </div>
                                            ...
                                            <div class="card-body pt-0 pb-0">
                                                <div class="row">
                                                    <div class="mb-7 fv-row">
                                                        <div class="fv-row">
                                                            <div class="row">
                                                                <label for="device_type" class="col required form-label fw-bold">{{ __('Device type') }}</label>
                                                                <span
                                                                    class="text-end col text-gray-900 fs-7">{{ __('Set the device type.') }}</span>
                                                            </div>
                                                        </div>

                                                        <select name="device_type" class="form-select mb-2" data-control="select2"
                                                                data-hide-search="true" data-placeholder="{{ __('Select an option') }}"
                                                                id="device_type">
                                                            <option value="sticker_printer">{{ __('Sticker printer') }}</option>
                                                    ...
                                                    <div class="mb-7 fv-row">
                                                        <label for="device_name" class="required form-label fw-bold">{{__('Device name')}}</label>
                                                        <input id="device_name" type="text" name="device_name"
                                                               class="form-control mb-2" placeholder="{{__('Device name')}}"/>
                                                    </div>

                                                    <div class="mb-7 fv-row">
                                                        <label for="device_ip" class="required form-label fw-bold">{{__('Device ip')}}</label>
                                                        <input id="device_ip" type="text" name="device_ip"
                                                               class="form-control mb-2" placeholder="{{__('Device ip')}}"/>
                                                    </div>
                                                    <div class="mb-7 fv-row">
                                                        <div class="fv-row">
                                                            <div class="row">
                                                        ...
                                                        <select name="device_port" class="form-select mb-2" data-control="select2"
                                                                data-hide-search="true" data-placeholder="{{ __('Select an option') }}"
                                                                id="device_port">
                                                            <option value="4100">{{ __('4100') }}</option>
                                                            <option value="9100">{{ __('9100') }}</option>
                                                        </select>
                                                    </div>
                                                    <div class="input-terminal" style="display: none">
                                                        <div class="mb-7 fv-row">
                                                            <div class="fv-row">
                                                                <div class="row">
                                                            ...
                                                            <select name="terminal_type" class="form-select mb-2" data-control="select2"
                                                                    data-hide-search="true" data-placeholder="{{ __('Select an option') }}"
                                                                    id="terminal_type">
                                                                <option value="ATTENDED_OPI_CH">{{ __('ATTENDED_OPI_CH') }}</option>
                                                                <option value="ATTENDED_OPI_DE">{{ __('ATTENDED_OPI_DE') }}</option>
                                                                <option value="UNATTENDED_OPI_DE">{{ __('UNATTENDED_OPI_DE') }}</option>
                                                                <option value="ATTENDED_OPI_NL">{{ __('ATTENDED_OPI_NL') }}</option>
                                                                <option value="UNATTENDED_OPI_NL">{{ __('UNATTENDED_OPI_NL') }}</option>
                                                                <option value="UNATTENDED_OPI_CH">{{ __('UNATTENDED_OPI_CH') }}</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-7 fv-row">
                                                            <label for="terminal_id" class="terminal-inputs required form-label fw-bold">{{__('Terminal ID')}}</label>
                                                            <input id="terminal_id" type="text" name="terminal_id"
                                                        ...
                                                        <div class="mb-7 fv-row">
                                                            ...
                                                            <select name="terminal_compatibility_port" class="form-select mb-2" data-control="select2"
                                                                ...
                                                                <option value="4102">{{ __('4102') }}</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-7 fv-row">
                                                            <div class="fv-row">
                                                            ...
                                                            <select name="terminal_socket_mode" class="form-select mb-2" data-control="select2"
                                                                    data-hide-search="true" data-placeholder="{{ __('Select an option') }}"
                                                                    id="terminal_socket_mode">
                                                                <option value="DUAL_SOCKET">{{ __('DUAL SOCKET') }}</option>
                                                                <option value="SINGLE_SOCKET">{{ __('SINGLE SOCKET') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="fv-row">
                                                        <div class="col">
                                                            <label class="form-check-label mb-4" for="device_status"><span
                                                            ...
                                                            <div class="form-check form-switch">
                                                                ...
                                                                <input class="form-check-input" id="device_status" name="device_status"

            ...
            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6 h-100px">
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        ...
                        <a href="{{route('ourLocation.index')}}" class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Edit location') }} > </a>
                        <span class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-2">{{ $ourLocation->name }}</span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <button class="btn delete-button btn-danger w-125px border-0"
                                data-id="{{ $ourLocation->id }}"
                                data-name="{{ $ourLocation->name }}">{{ __('Delete') }}</button>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_ourLocation_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $ourLocation->id }}">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="row">
                                                    <div class="fv-row col-6">
                                                        ...
                                                        <input id="name" type="text" name="name" value="{{ $ourLocation->name }}"
                                                    ...
                                                    <div class="fv-row col-6">
                                                        ...
                                                        <input id="location" type="text" name="location" value="{{ $ourLocation->location }}"
                                                ...
                                                <div class="row">
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="form-check form-switch mb-3">
                                                            <input class="form-check-input" {{ $ourLocation->pos ? 'checked' : '' }} name="pos" type="checkbox" role="checkbox" id="pos_1" value="1">
                                                    ...
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="form-check form-switch mb-3">
                                                            <input class="form-check-input" {{ $ourLocation->kitchen ? 'checked' : '' }} name="kitchen" type="checkbox" role="checkbox" id="kitchen_1" value="1">
                                                    ...
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="form-check form-switch mb-3">
                                                            <input class="form-check-input" {{ $ourLocation->e_kiosk ? 'checked' : '' }} name="e_kiosk" type="checkbox" role="checkbox" id="e_kiosk_1" value="1">
                                                    ...
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="form-check form-switch mb-3">
                                                            <input class="form-check-input" {{ $ourLocation->integrated_payments ? 'checked' : '' }} name="integrated_payments" type="checkbox" role="checkbox" id="integrated_payments" value="1">
                                                    ...
                                                    <div class="fv-row mb-5">
                                                        ...
                                                        <div class="form-check form-switch mb-3">
                                                            <input class="form-check-input" {{ $ourLocation->manual_payments ? 'checked' : '' }} name="manual_payments" type="checkbox" role="checkbox" id="manual_payments" value="1">
                                        ...
                                        <div class="card card-flush py-2">
                                            ...
                                            <div class="card-body pt-1 pb-0">
                                                <div class="row">
                                                    ...
                                                    <div class="fv-row col-6 pt-2">
                                                        <div class="form-check form-switch  mb-7">
                                                            <input class="form-check-input check-taxes" name="dine_in" type="checkbox" role="checkbox" id="dine_in" value="1" {{ $ourLocation->dine_in ? 'checked' : '' }}>
                                                            <label class="form-check-label text-gray-800 fw-bold" for="dine_in">{{__('Dine In')}}</label>
                                                            <span
                                                    class="small p-5 text-gray-900">{{ __('Automatically open the system keyboard as necessary for Dine-In orders') }}</span>
                                                        </div>
                                                        <div class="form-check form-switch  mb-7">
                                                            <input class="form-check-input" {{ $ourLocation->has_tables ? 'checked' : '' }}  name="has_tables" type="checkbox" role="checkbox" id="has_tables" value="1">
                                                        ...
                                                        <div class="form-check form-switch  mb-7">
                                                            <input class="form-check-input" {{ $ourLocation->has_locators ? 'checked' : '' }} name="has_locators" type="checkbox" role="checkbox" id="has_locators" value="1">
                                                            <label class="form-check-label text-gray-800 fw-bold" for="has_locators">{{__('Has locators')}}</label>
                                                            {{--                                                            <span class="small p-5 text-gray-900">{{ __('Automatically open the system keyboard as necessary for Dine-In orders') }}</span>--}}
                                                        </div>
                                                        <div class="form-check form-switch mb-7">
                                                            <input class="form-check-input check-taxes" name="take_away" type="checkbox" role="checkbox" id="take_away" value="1" {{ $ourLocation->take_away ? 'checked' : '' }}>
                                                    ...
                                                    class="small p-5 text-gray-900">{{ __('Automatically open system keyboard as necessary for Take away orders') }}</span>
                                                        ...
                                                        <div class="form-check form-switch mb-7">
                                                            <input class="form-check-input check-taxes" name="delivery" type="checkbox" role="checkbox" id="delivery" value="1" {{ $ourLocation->delivery ? 'checked' : '' }}>
                                                    ...
                                                    class="small p-5 text-gray-900">{{ __('Automatically open the system keyboard as necessary for Delivery orders') }}</span>
                                                        ...
                                                        <div class="form-check form-switch mb-7">
                                                            <input class="form-check-input" @checked($ourLocation->auto_print) name="auto_print" type="checkbox" id="auto_print" role="checkbox" value="1">

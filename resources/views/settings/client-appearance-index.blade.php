...
@section('setup-script')
    @vite('resources/assets/js/custom/apps/settings/client-appearance.js')
@endsection
@section('content')
                    ...
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('settings') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Settings') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ __('Client appearance') }}</span>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="card-body text-center pt-0">
                        <style>
                            .image-input-placeholder {
                                background-image: url('{{ $clientIcon }}');
                            }
                        </style>
                        <form id="kt_ecommerce_appearance">
                            <div
                                class="mx-5 image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <label
                                    ...
                                    <input type="file" name="client_icon" accept=".png, .svg, .webp, .jpg, .jpeg"/>

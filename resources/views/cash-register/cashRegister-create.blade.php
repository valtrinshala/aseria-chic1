                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('cashRegister.index') }}"
                            class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Cash registers') }} ></a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ __('Add new cash register') }}</span>
                    </div>
                                ...
                                <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general"
                                    ...
                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                        <div class="card card-flush py-4">
                                            <div class="card-header">
                                                <div class="card-title">
                                                    <h2>{{ __('Cash register Details') }}</h2><span
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-10 col-12 fv-row">
                                                        ...
                                                        <input id="pin" type="number" name="pin"
                                                            class="form-control" placeholder="{{ __('Cash register authentication pin') }}" />
                                                    ...
                                                    <div class="mb-10 col-12 fv-row">
                                                        ...
                                                        <div class="shared-input-container mb-2">
                                                        <input id="pin_for_settings" type="password" name="pin_for_settings"
                                                            class="form-control" placeholder="{{ __('Pin for payment terminal settings') }}" />
                                                            <span class="toggle-password">
                                                                <i class="fa fa-eye-slash"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="mb-10 col-12 fv-row">
                                                        ...
                                                        <div class="shared-input-container mb-2">
                                                            <input id="pin_to_print_reports" type="password" name="pin_to_print_reports"

                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('ingredient.index') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Ingredients') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $ingredient->name }}</span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        @include('button-language-add-items', [
                            'url' => 'ingredient.edit',
                            'keyUrl' => 'ingredient',
                            'valueUrl' => $ingredient->id,
                        ])
                        <a href="{{ route('ingredient.index') }}"
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_ingredient_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $ingredient->id }}">
                                            ...
                                            <div class="card-body pt-0 pb-0">
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <input type="text" name="name" class="form-control mb-2"
                                                           placeholder="{{__("Ingredient name")}}" value="{{ !request()->query('language_update_id') ? $ingredient->getAttributes()['name']: $ingredient->translate?->name }}" />
                                            ...
                                            <div class="card-body py-0">
                                                <div class="row">
                                                 ...
                                                 <input id="cost" type="text" autocomplete="off" name="cost"
                                                        value="{{ $ingredient->cost }}" class="form-control mb-2"
                                                        placeholder="{{__("Ingredient cost")}}" />
                                                    </div>
                                                    <div class="mb-10 fv-row col">
                                                        <label for="price"
                                                        ...
                                                        value="{{ $ingredient->price }}" class="form-control mb-2"
                                                        placeholder="{{__('Ingredient price')}}" />
                                                    </div>
                                                    <div class="mb-10 fv-row col">
                                                        <div class="mb-10 fv-row col">
                                                            <label for="unit"
                                                                   class="required form-label fw-bold">{{ __('Unit') }}</label>
                                                            <select name="unit" class="form-select mb-2"
                                                                ...
                                                                @foreach ($units as $unit)
                                                                    <option
                                                                        {{ $ingredient->unit == $unit->suffix ? 'selected' : '' }}
                                                                        value="{{ $unit->suffix }}">{{ $unit->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="quantity" type="text" autocomplete="off" name="quantity"
                                                               value="{{ $ingredient->quantity }}" class="form-control mb-2"
                                                    ...
                                                    <div class="mb-10 fv-row col">
                                                        ...
                                                        <input id="alert_quantity" type="text" autocomplete="off" name="alert_quantity"
                                                               value="{{ $ingredient->alert_quantity }}"

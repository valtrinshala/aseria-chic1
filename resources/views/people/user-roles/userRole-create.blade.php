                    ...
                    <div class="page-title d-flex justify-content-center flex-wrap me-3 m-5">
                        <a href="{{ route('userRole.index') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Roles ') }}
                            ></a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ __('Add new role') }}</span>
                    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general"
                                    ...
                                    <div class="d-flex flex-column gap-7 gap-lg-7">
                                        ...
                                        <div class="card card-flush py-4 m-0 mt-0 p-0">
                                            <div class="card-header mb-3">
                                                <div class="card-title">
                                                    <h2>{{ __('Permissions') }}</h2> <span
                                                        class="small p-5 text-gray-900">{{ __('Sections of the application permission.') }}</span>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="mb-10 fv-row col-6">
                                                        <div class="mb-10">
                                                            ...
                                                            @foreach ($permissions->pos_area as $key => $permission)
                                                                <div class="form-check form-switch mb-3">
                                                                    <input
                                                                        class="form-check-input @if($key !== 0) display-pos-settings @else pos-module @endif"
                                                                        @if($key !== 0) disabled @endif
                                                                        name="{{ $permission->nameInput }}"
                                                                        type="checkbox"
                                                                        role="checkbox"
                                                    ...
                                                    <div class="mb-10 fv-row col-6">
                                                        <div class="mb-10">
                                                            ...
                                                            @foreach ($permissions->kitchen_area as $key => $permission)
                                                                <div class="form-check form-switch mb-3">
                                                                    <input
                                                                        class="form-check-input @if($key !== 0) display-kitchen-settings @else kitchen-module @endif"
                                                                        @if($key !== 0) disabled @endif
                                                                        name="{{ $permission->nameInput }}"
                                                                        type="checkbox"
                                                                        role="checkbox"

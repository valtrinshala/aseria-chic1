                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('customer.index') }}"
                            class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Customers') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $customer->name }}</span>
                    </div>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_customer_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $customer->id }}">
                                            ...
                                            <div class="card-body pt-0 pb-0">
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        <label for="name"
                                                            class="required form-label">{{ __('Name') }}</label>
                                                        <input id="name" type="text" name="name"
                                                            value="{{ $customer->name }}" class="form-control mb-2"
                                                            placeholder="Ex. John Doe" />
                                                    </div>
                                                    <div class="mb-10 fv-row col">
                                                        <label for="email"
                                                            class="required form-label">{{ __('Email') }}</label>
                                                        <input id="email" type="email" name="email"
                                                            value="{{ $customer->email }}" class="form-control mb-2"
                                                ...
                                                <div class="row">
                                                    <div class="mb-10 fv-row col">
                                                        <label for="phone"
                                                            class="required form-label">{{ __('Phone') }}</label>
                                                        <input id="phone" type="number" name="phone"
                                                            value="{{ $customer->phone }}" class="form-control mb-2"
                                                            placeholder="{{__("Phone number")}}" />
                                                    </div>
                                                    <div class="mb-10 fv-row col">
                                                        <label for="address"
                                                            class="required form-label">{{ __('Address') }}</label>
                                                        <input id="address" type="text" name="address"
                                                            value="{{ $customer->address }}" class="form-control mb-2"

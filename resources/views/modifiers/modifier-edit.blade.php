...
@section('setup-script')
    @vite('resources/assets/js/custom/apps/modifiers/update.js')
@endsection
@section('content')
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid m-9 mt-0">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('modifier.index') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Edit modifiers') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $modifier->title }}</span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        @include('button-language-add-items', [
                            'url' => 'modifier.edit',
                            'keyUrl' => 'modifier',
                            'valueUrl' => $modifier->id,
                        ])
                        <a href="{{ route('modifier.index') }}"
            ...
            <input type="hidden" id="pageId" value="{{ $modifier->id }}">
...
{{--                                                    <div class="col-10">--}}
{{--                                                        <span--}}
{{--                                                            class="small">{{ __('The modifiers of this category will associate with this color') }}</span>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <span>{{ __('Note: You cannot change the color of the modifier. This color will be predefined in the food category.') }}</span>--}}
{{--                                            </div>--}}
...
{{--                                                             style="background-image: url('{{ $modifier->getImage() }}')">--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0 pb-1">
                                    <div class="fv-row">
                                        ...
                                        <select id="categories" name="categories[]" class="form-select mb-2" data-control="select2" multiple="multiple"
                                                data-placeholder="{{ __('Select an option') }}" data-allow-clear="true">
                                            @foreach ($categories as $category)
                                                <option {{ in_array($category->id, $modifier->category->pluck('id')->toArray()) ? 'selected' : '' }}
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0 pb-1">
                                    ...
                                    <select name="status" class="form-select mb-2" data-control="select2"
                                        ...
                                        <option></option>
                                        <option {{ $modifier->status ? 'selected' : '' }}
                                                value="1">{{ __('Published') }}</option>
                                        <option
                                            {{ !$modifier->status ? 'selected' : '' }} value="0">
                                            {{ __('Inactive') }}</option>
                                    </select>
                                </div>
                            </div>
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0 pb-1">
                                                <div class="mb-10 fv-row">
                                                    <div class="row">
                                                        <label
                                                            class="col required form-label fw-bold">{{ __('Modifier Title') }}</label>
                                                        <span class="col text-end text-gray-900 fs-7">
                                                            {{ __('A modifier title is required and recommended to be unique.') }}
                                                        </span>
                                                        <input type="text" name="title"
                                                               class="form-control mb-2 ms-2"
                                                               placeholder="{{ __('Modifier title') }}"
                                                               value="{{ !request()->query('language_update_id') ? $modifier->getAttributes()['title']: $modifier->translate?->title }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body pt-0 pb-0">
                                                <div class="mb-10">
                                                    ...
                                                    <textarea name="description" class="form-control mb-3" rows="4"
                                                              placeholder="{{ __('Type a message') }}">{{ !request()->query('language_update_id') ? $modifier->getAttributes()['description']: $modifier->translate?->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card card-flush py-4 pb-0 fv-row">
                                            <div class="card-header">
                                                <div class="card-title">
                                                ...
                                                <div class="fv-row mb-2">
                                                    ...
                                                    <div class="card card-body pt-0 px-2 pb-0">
                                                        <table class="table align-middle table-row-dashed gy-5"
                                                            ...
                                                            <tbody>
                                                            @foreach ($modifier->ingredients as $ingredient)

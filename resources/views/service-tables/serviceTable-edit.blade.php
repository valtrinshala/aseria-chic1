                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('serviceTable.index') }}"
                            class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Edit table') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $serviceTable->title }}</span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <button class="btn delete-button btn-danger w-125px border-0"
                                data-id="{{ $serviceTable->id }}"
                                data-name="{{ $serviceTable->title }}">{{ __('Delete') }}</button>
                        <a href="{{ route('serviceTable.index') }}"
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_serviceTable_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $serviceTable->id }}">
                                                ...
                                                <div class="row">
                                                    <div class="mb-5 fv-row col">
                                                        ...
                                                        <input id="title" type="text" name="title"
                                                            value="{{ $serviceTable->title }}" class="form-control mb-2"

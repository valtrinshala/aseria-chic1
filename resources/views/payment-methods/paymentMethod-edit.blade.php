                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex justify-content-center flex-wrap me-3">
                        <a href="{{ route('paymentMethod.index') }}"
                           class="page-heading d-flex text-gray-900 fs-3 flex-column justify-content-center my-0">{{ __('Payment methods') }}
                            > </a>
                        <span
                            class="page-heading d-flex text-info fw-bold fs-3 flex-column justify-content-center my-0 m-4">{{ $paymentMethod->name }}</span>
                    </div>
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <button class="btn delete-button btn-danger w-125px border-0"
                                data-id="{{ $paymentMethod->id }}"
                                data-name="{{ $paymentMethod->name }}">{{ __('Delete') }}</button>
                        <a href="{{ route('paymentMethod.index') }}"
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_ecommerce_add_paymentMethod_form" class="form d-flex flex-column flex-lg-row">
                        ...
                        <input type="hidden" id="page-id" value="{{ $paymentMethod->id }}">
                        <input type="hidden" value="{{ $paymentMethod->color }}" name="color" class="input-color">
                                                ...
                                                <div class="card-body pt-7 pb-0 px-0">
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade active show"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-7 mx-4 card h-250px paymentMethod-color"
                                                                     style="background-color:{{ $paymentMethod->color }}"></div>
                                                        ...
                                                        <div class="tab-pane fade" id="kt_security_summary_tab_pane_day"
                                                             role="tabpanel">
                                                            <div class="image-input w-100 mb-3"
                                                                ...
                                                                <div class="d-flex justify-content-center">
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image: url('{{ $paymentMethod->getImage() }}')"></div>
                                                                </div>
                                                            </div>
                                                            <div
